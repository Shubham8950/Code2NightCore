...
namespace Code2Night.DAL.Common
{
    ...
    {
        public static string sqlConStr = default;
        ...
        public Connection()
        {
            _config = new ConfigurationBuilder().SetBasePath(CurrentDirectoryHelpers.GetServerPath()).AddJsonFile("appSettings.json").Build();
            sqlConStr = _config["ConnectionStrings:ConnectionString"];
        }
